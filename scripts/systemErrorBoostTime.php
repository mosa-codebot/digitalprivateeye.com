...
foreach($devices as $device)
{
    ...
    $subject = "Booster $trialDays day subscription has been added to your device, $deviceName's account";
...
It costs as little as 4.99 CAD to extend your devices subscription. Payments are acccepted by Paypal, credit cards and Interac Email Transfer on $paymentPageUrl.
