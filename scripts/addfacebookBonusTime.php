...
foreach($usersToCredit as $user)
{
    ...
    $subject = "Facebook Promo - New coupon activated";
    $body = "Hello,

Thank you for your recent Facebook like. 

A coupon (coupon id: $couponCode) has been created for you. You can view all your coupons at $viewCouponsUrl.
