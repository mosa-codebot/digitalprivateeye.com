...
foreach($devices as $device)
{
    ...
    $subject = $appName ." - Boost $trialDays days have been added to your device, $deviceName's account";
...
A boost subscription period of $trialDays days has been added to your device's account ($deviceName). 
...
It costs only as little as 4.99 CAD to extend your devices subscription. Payments are acccepted by Paypal, credit cards and Interac Email Transfer on $paymentPageUrl.
