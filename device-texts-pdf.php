...
if (file_exists('tcpdf/tcpdf.php')) {
    ...
    $texts = $devicesModel->getDeviceAllTexts($deviceId);
    ...
    $pdf->SetHeaderData("../../../img/logo.png", 15, $deviceDescription."'s Texts (".$date." GMT)",
    ...
    $output = $output . "<tr>
                            ...
                            <td width=\"20%\"><strong>Text Type</strong></td>
                            <td width=\"40%\"><strong>Duration</strong></td>
                         </tr>";
    ...
    foreach($texts as $text)
    {
        ...
        if($messageType=='1') $messageType = "Incoming";
        if($messageType=='2') $messageType = "Outgoing";
    ...
    $pdf->Output($deviceDescription.'_Texts.pdf', 'I');
}
else{
