...
if($_POST)
{
    ...
    $message = "<div style='color:red;'>Addition of facebook bonus time has failed.</div>";
    if(($time)&&($userId))
    {
        if($devices->addFacebookBonus($time, $userId))
            $message = "<div style='color:green;'>Facebook bonus time successfully added.</div>";
    }
}
?>
...
<body>
  ...
  <?php include("nav-bar.php");?>
    ...
    <div class="container-fluid">
        ...
        <div class="span9">
            <h1 class="page-title">Add Facebook Bonus</h1>
